...
export async function generateMgmServerActivityRankingPdf(
  ...
  const docDefinition = {
    info: {
      title: `MGM Server Activity Ranking - ${migrationLabel}`,
      author: "SIRO ARC Statistics",
      subject: "MGM Server Activity Ranking",
    },
        ...
        columns: [
...

          {
            ...
            stack: [
              ...
              {
                text: "MGM Server Activity Ranking",
                style: "subtitle",
                margin: [0, 4, 0, 0],
              },
              {
    ...
    alignment: "right",
            ...
            ...rankings.map((entry) => {
              ...
              return [
                ...
                {
  text: entry.alliances.toLocaleString("en-US"),
  alignment: "right",
  color: textColor,
  fillColor: rowColor,
},
...

{
  ...
  pdfMake
    ...
    .download(
      `SIRO_MGM_Server_Activity_${migrationLabel.replace(
        /-/g,
        ""
      )}.pdf`
    );
