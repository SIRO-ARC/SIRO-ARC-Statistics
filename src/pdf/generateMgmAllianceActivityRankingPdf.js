...
export async function generateMgmAllianceActivityRankingPdf(
  ...
  /*
   * Exactly 20 ranking entries on page 1.
   * 25 ranking entries on every following page.
   */
  ...
  rankingChunks.forEach((chunk, index) => {
    ...
    /*
     * Alliance Activity has a two-line style hierarchy similar
     * to the MGM Server Activity reference PDF.
     */
    content.push({
      text: "",
  ...
  const docDefinition = {
    ...
    info: {
      title:
        `MGM Alliance Activity Ranking - ${migrationLabel}`,
