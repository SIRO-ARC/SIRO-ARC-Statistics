...
export async function generateMgmAverageParticipantsRankingPdf(
  rankings,
  dataset
) {
  ...
  const docDefinition = {
    info: {
      title: `MGM Average Participants Ranking - ${migrationLabel}`,
      author: "SIRO ARC Statistics",
      subject: "MGM Average Participants Ranking",
    },
        ...
        columns: [
...

          {
            ...
            stack: [
              ...
              {
                text: "MGM Average Participants Ranking",
                style: "subtitle",
                margin: [0, 4, 0, 0],
              },
              {
          ...
          body: [
            ...
            ...rankings.map((entry) => {
              ...
              return [
                ...
                {
                  text: entry.averageParticipants.toFixed(1),
                  alignment: "right",
                  bold: true,
                  color: textColor,
                  fillColor: rowColor,
  ...
  pdfMake
    ...
    .download(
      `SIRO_MGM_Average_Participants_${migrationLabel.replace(
        /-/g,
        ""
      )}.pdf`
    );
