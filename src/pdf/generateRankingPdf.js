...
async function getLogoBase64() {
  return new Promise((resolve) => {
    ...
    img.onload = () => {
      ...
      /*
       * Create a real rounded clipping mask.
       * This makes the logo itself have soft corners
       * instead of placing it inside a separate circle.
       */
...
const now = new Date();
  ...
  /*
   * Exactly 20 ranking entries per page.
   */
...
content.push({
  ...
  // Space between header and table on page 1
  content.push({
  text: "",
  margin: isFirstPage
    ? [0, headerSpacing, 0, 0]
  ...
  return {
    ...
    footer(currentPage, pageCount) {
      return {
        ...
        columns: [
          {
            text: "SIRO STATS  •  siro-stats.com",
            color: "#587086",
            fontSize: 8,
          },
