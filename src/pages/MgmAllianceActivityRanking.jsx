...
import { generateMgmAllianceActivityRankingPdf } from "../pdf/generateMgmAllianceActivityRankingPdf";
import { formatDate } from "../utils/formatDate";

export default function MgmAllianceActivityRanking() {
  ...
  const ranking = useMemo(() => {
    ...
    mgmData.forEach((entry) => {
      ...
      // Use the server from the most recent MGM entry.
      if (
        new Date(entry.date) >=
        new Date(grouped[allianceId].latestDate || entry.date)
      ) {
    ...
    <>
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 lg:py-16">
        ...
        <p className="mt-3 text-slate-400">
          Rank alliances by their total participant activity across
        ...
        <div className="mt-10">
          ...
          <div className="mt-4 flex flex-col gap-4 lg:flex-row">
            ...
            <button
              onClick={() =>
                generateMgmAllianceActivityRankingPdf(
                  filteredRanking,
                  dataset
                )
              }
