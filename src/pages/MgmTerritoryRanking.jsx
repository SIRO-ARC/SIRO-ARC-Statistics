...
import { generateMgmTerritoryRankingPdf } from "../pdf/generateMgmTerritoryRankingPdf";
import { formatDate } from "../utils/formatDate";

export default function MgmTerritoryRanking() {
...

    {
      ...
      render: (row) => (
        <span className="font-bold text-sky-400">
          {Number(row.captured || 0).toLocaleString()}
        </span>
      ),
    },
  ];
    ...
    <>
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 lg:py-16">
        ...
        <p className="mt-3 text-slate-400">
          Rank individual alliance participations by captured territory
        ...
        <div className="mt-10">
          ...
          <div className="mt-4 flex flex-col gap-4 lg:flex-row">
            ...
            <button
              onClick={() =>
                generateMgmTerritoryRankingPdf(
                  filteredRanking,
                  dataset
                )
              }
